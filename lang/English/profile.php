...
/*RUS*/'Reputation adm'			=>	'Изменить настройки репутации',
...
/*RUS*/'Avatar info'				=>	'Аватар — это маленькое изображение, которое будет отображаться под Вашим именем в сообщениях на форуме.',
...
/*RUS*/'Male'						=>	'Мужчина',
/*RUS*/'Female'					=>	'Женщина',
/*RUS*/'Do not show'				=>	'Не показывать',
/*RUS*/'Unknown'					=>	'(Неизвестно)',
'Location'					=>	'Location',
/*RUS*/'Country'					=>	'Страна',
'From'						=>	'From',
...
'Note'						=>	'Note',
'Posts'						=>	'Posts',
/*RUS*/'Posts in day'				=>	'(%s в день)',
'Last post'					=>	'Last post',
/*RUS*/'Last visit'            	=>	'Последние посещение',
...
/*RUS*/'Vkontakte'					=>	'В Контакте',
/*RUS*/'Сlassmates'				=>	'Одноклассники',
...
/*RUS*/'Show bb panel'				=>	'Показывать панель BB-кодов.',
'Show smilies'				=>	'Show smilies as graphic icons.',
'Signature display'			=>	'Signature display',
/*RUS*/'BB panel display'			=>	'Панель BB-кодов',
